...
จุดเด่นของโครงงาน กล่าวคือ ข้อมูลภาพยนตร์ที่คล้ายกันได้มาจาก API โดยตรง จึงไม่จำเป็นต้องสร้างโมเดลแนะนำ (Recommendation Model) ขึ้นเอง ขณะที่ตรรกะการคัดเลือก การจัดอันดับ การจัดการคลังข้อมูล และการส่งออก เป็นส่วนที่ทีมพัฒนาขึ้นเองทั้งหมด ทำให้ขอบเขตของโครงงานเหมาะสม และแสดงทักษะการเขียนโปรแกรมครบถ้วนตามเกณฑ์รายวิชา
...
✅ การวิเคราะห์และจัดการข้อมูล (Data Analysis & Management): สอดคล้องกับตัวอย่างที่ระบุในเอกสารรายวิชา (movie ratings analyzer)
...
- Core Developer(s): นายอเสข ปัญญาวงค์ (ผู้จัดทำ)
